...
public class ProductServiceImpl implements ProductService {
    ...
    public CompletableFuture<ProductFormDTO> create(ProductFormDTO formDTO) {
        ...
        final ProductFormDTO retFormDTO = ProductMapper.convertToFormDto(productRepository.save(ProductMapper.convertToModel(formDTO)));
    ...
    public CompletableFuture<ProductQueryDTO> getOne(Integer id) {
        ...
        final ProductQueryDTO productQueryDTO =
                ProductMapper.convertToQueryDto(mayBeProduct.orElseThrow(() -> new CustomException(PRODUCT_NOT_FOUND_EXCEPTION, HttpStatus.NOT_FOUND)));
